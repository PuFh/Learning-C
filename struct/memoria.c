...
int main() {
    ...
    printf("%d\n",sizeof(data));
    //note que retorna 120 bytes, porem ao analisar vemos que temos um totaal de 117 bytes.
    //esses 3 bytes são usados para gerenciamento da memoria, já que estamos trabalhondo com varios tipos de variaveis(int e char).
